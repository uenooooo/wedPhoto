...
export const handler = async (event) => {
  for (const record of event.Records ?? []) {
    ...
    if (type.startsWith("video/")) {
      ...
      await mediaConvert.send(new CreateJobCommand({ Role: process.env.MEDIACONVERT_ROLE_ARN, Settings: { Inputs: [{ FileInput: `s3://${bucket}/${key}`, VideoSelector: { Rotate: "AUTO" }, AudioSelectors: { "Audio Selector 1": { DefaultSelection: "DEFAULT" } } }], OutputGroups: [{ OutputGroupSettings: { Type: "FILE_GROUP_SETTINGS", FileGroupSettings: { Destination: `s3://${bucket}/ready/` } }, Outputs: [{ ContainerSettings: { Container: "MP4", Mp4Settings: { MoovPlacement: "PROGRESSIVE_DOWNLOAD" } }, VideoDescription: { CodecSettings: { Codec: "H_264", H264Settings: { RateControlMode: "QVBR", QvbrSettings: { QvbrQualityLevel: 7 }, MaxBitrate: 8000000, FramerateControl: "INITIALIZE_FROM_SOURCE", ParControl: "INITIALIZE_FROM_SOURCE" } } }, AudioDescriptions: [{ AudioSourceName: "Audio Selector 1", CodecSettings: { Codec: "AAC", AacSettings: { RateControlMode: "CBR", Bitrate: 128000, CodingMode: "CODING_MODE_2_0", SampleRate: 48000 } } }] }] }] } }));
    }
  }
};
